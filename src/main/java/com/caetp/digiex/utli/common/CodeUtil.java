...
public class CodeUtil {
	private static int width = 128;// 定义图片的width
	private static int height = 56;// 定义图片的height
	private static int codeCount = 4;// 定义图片上显示验证码的个数
	private static int xx = 23;
	...
	public static Map<String, Object> getCode() {
		...
		Font font = new Font("Serief",Font.ITALIC, fontHeight);
		// 设置字体。
		gd.setFont(font);
